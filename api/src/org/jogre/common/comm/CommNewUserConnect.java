 ...
 * @version Beta 0.3
 */
public class CommNewUserConnect extends CommGameMessage {
	 ...
	 */
	public CommNewUserConnect (String username) {
	    super (username);
	}
	 ...
	 */
	public CommNewUserConnect (String username, String gameID) {
	    super (username);
	 ...
	 * @param gameID     Game ID i.e. game-version (e.g. chess-0.2).
	 */
	public CommNewUserConnect (String username, String password, String gameID) {
	 ...
	 */
	public CommNewUserConnect (XMLElement message) throws TransmissionException {
		super (message);
