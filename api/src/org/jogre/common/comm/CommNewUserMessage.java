 ...
 * @version Beta 0.3
 */
public abstract class CommNewUserMessage implements ITransmittable {
	 ...
	 */
	protected CommNewUserMessage (int status) {
		this (status, null);
	}
	 ...
	 * @param usernameTo
	 */
	public CommNewUserMessage (String username) {
	 ...
	 * @param usernameTo
	 */
	public CommNewUserMessage (int status, String username) {
	    this.status = status;
	 ...
	 */
	protected CommNewUserMessage (XMLElement message) {
